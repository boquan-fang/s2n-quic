...
pub use self::rand::{AwsLc, Provider as Default, Random, ReseedingRng};
...
mod rand {
    ...
    /// The default random generator, using AwsLc as the entropy source.
    #[derive(Debug)]
    pub struct Generator(Random<AwsLc>);

    impl Default for Generator {
        fn default() -> Self {
            Self(Random::new(AwsLc, AwsLc))
        }
    }
